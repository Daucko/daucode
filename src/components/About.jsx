  ...
  return (
    <main className="text-left mt-10">
      ...
      <p className="text-xl md:text-xl mt-4">
        ...
        engineering expertise and technical skills enables me to craft intuitive
        interfaces, uncover hidden insights, and drive business forward. From
        designing circuits to developing data-driven solutions, my journey has
        been marked by a passion for creative problem-solving and a relentless
